...
const PreCheckoutCard: React.FC<PreCheckoutCardProps> = ({
    ...
    return (
        <div className={`flex flex-col h-full ${theme.background} p-4 rounded-3xl text-white shadow-2xl border ${theme.border} relative overflow-hidden w-full animate-gold-pulse`}>
            ...
            {/* CHECKOUT HIGHLIGHT */}
            <div className={`bg-[#252535] p-4 rounded-xl border ${theme.border} shadow-lg relative overflow-hidden mb-3 text-center`}>
                ...
                <div className="flex flex-col items-center justify-center gap-1 mb-3">
                    <p className={`text-3xl font-mono font-bold ${theme.text.primary} tracking-widest drop-shadow-md`}>
