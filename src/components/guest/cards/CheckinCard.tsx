    ...
    return (
        <div className={`flex flex-col h-full ${theme.background} p-4 rounded-3xl text-white shadow-2xl border ${theme.border} relative overflow-hidden w-full animate-gold-pulse`}>
            ...
            <div className="flex justify-between items-start mb-6 relative z-10">
                <h2 className={`text-[10px] font-heading font-extrabold uppercase tracking-[0.15em] mt-1.5 ${isSingleNight ? 'text-orange-400' : 'text-gray-500'}`}>
            ...
            <div className="mb-6 relative z-10 text-center">
                <h3 className={`text-xl font-heading font-bold ${theme.text.primary} mb-2 flex items-center justify-center gap-2`}>
                    {isSingleNight ? `Veio rapidinho, ${config.guestName?.split(' ')[0]}? 👋` : 'Feliz em te receber! 😄'}
                </h3>
                <p className={`text-xs ${theme.text.secondary} font-medium leading-relaxed max-w-xs mx-auto`}>
                    {isSingleNight ? 'Aproveite ao máximo sua estadia!' : 'Faça o check-in sem estresse com o passo a passo!'}
                </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-4 relative z-10">
                ...
                >
                    ...
                    <div className="w-full">
                        ...
                        <p className={`text-sm font-bold ${theme.text.primary} truncate leading-none mb-1 w-full`}>{currentWifiSSID}</p>
                ...
                >
                    ...
                    <div className="w-full">
                        ...
                        <p className={`text-sm font-bold ${theme.text.primary} truncate leading-none mb-1`}>R. São José, 475B</p>
