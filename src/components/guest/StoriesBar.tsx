                        ...
                        >
                            ...
                            <div className="w-[58px] h-[58px] relative rounded-full flex items-center justify-center transform transition-transform duration-300 group-hover:scale-105">
                                ...
                                <div className="absolute inset-[2.5px] bg-gray-900 rounded-full flex items-center justify-center z-10 border border-white/10">
                                    <CalendarHeart
                                        size={22}
                                        className="text-pink-400 relative z-10 animate-breathing"
                                        strokeWidth={2}
                                    />
                    ...
                    >
                        <div className="w-[58px] h-[58px] relative rounded-full flex items-center justify-center transform transition-transform duration-300 group-hover:scale-105">
                            ...
                            <div className="absolute inset-[2.5px] bg-gray-900 rounded-full flex items-center justify-center z-10 border border-white/10">
                                <Sparkles
                                    size={22}
                                    className="text-indigo-300 relative z-10 animate-breathing"
                                    strokeWidth={2}
                                />
                            </div>
                        </div>
                        ...
                        >
                            <div className="w-[58px] h-[58px] relative rounded-full flex items-center justify-center transform transition-transform duration-300 group-hover:scale-105">
                                ...
                                <div className="absolute inset-[2.5px] bg-gray-900 rounded-full flex items-center justify-center z-10 border border-white/10">
                                    <Lightbulb
                                        size={22}
                                        className="text-yellow-300 relative z-10 animate-breathing"
                                        strokeWidth={2}
                                    />
                                </div>
                            </div>
