    ...
    return (
      ...
      `}</style>
            ...
            <div className="relative flex items-center justify-center w-full max-w-md px-10 mb-8">
                {/* Left Line */}
                <div
                    className={`h-[2px] flex-1 bg-gradient-to-r ${current.gradientLeft} line-left rounded-full`}
                />
                ...
                {/* Right Line */}
                <div
                    className={`h-[2px] flex-1 bg-gradient-to-l ${current.gradientRight} line-right rounded-full`}
                />
            </div>
