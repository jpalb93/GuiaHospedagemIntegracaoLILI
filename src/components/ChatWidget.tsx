...
const ChatWidget: React.FC<ChatWidgetProps> = ({
    ...
    return (
        <>
            {/* Label "Tire dúvidas" */}
            <div
                className={`fixed bottom-24 right-6 z-40 pointer-events-none transition-all duration-500 ${isOpen ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'}`}
            >
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="font-bold font-heading text-lg">
                                {language === 'pt' ? 'Concierge Virtual' : 'Virtual Concierge'}
                            </h3>
                            ...
                            placeholder={
                                isListening
                                    ? language === 'pt'
                                        ...
                                        : 'Listening...'
                                    : language === 'pt'
                                      ? 'Pergunte sobre o flat ou a cidade...'
                                      : 'Ask about the flat or the city...'
                            }
