                ...
                <div className="p-6 overflow-y-auto">
                    ...
                    {step === 1 && (
                        <form onSubmit={handleCreatePayment} className="space-y-4">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-amber-700 text-white py-3 rounded-xl font-bold hover:bg-amber-800 transition-all shadow-lg flex justify-center items-center gap-2 mt-4"
                            >
                                {loading ? (
                    ...
                    {step === 2 && paymentData && (
                        <div className="flex flex-col items-center text-center space-y-6">
                            <div className="bg-green-50 text-green-800 p-4 rounded-lg w-full">
                                ...
                                <p className="text-sm">
                                    Realize o pagamento para garantir suas datas.
                                </p>
                            </div>
                            ...
                            <div className="w-full">
                                ...
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        className="flex-1 bg-gray-100 border border-gray-200 rounded-lg p-2 text-xs font-mono text-gray-600 truncate"
                                    />
                                    <button
                    ...
                    {step === 3 && (
                        <div className="flex flex-col items-center text-center py-8 animate-fadeIn">
                            ...
                            <button
                                onClick={onClose}
                                className="w-full bg-gray-900 text-white py-3 rounded-xl font-bold hover:bg-gray-800 transition-all shadow-lg"
                            >
                                Fechar
                            </button>
                        </div>
