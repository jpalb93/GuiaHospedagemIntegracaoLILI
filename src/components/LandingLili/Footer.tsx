...
const Footer: React.FC = () => {
    return (
        <footer className="bg-gray-900 text-white py-24 text-center">
            ...
            <p className="text-gray-500 font-light text-sm tracking-widest uppercase mb-8">
                By Flats Integração
            </p>
            <div className="flex justify-center gap-6 opacity-50 mb-12">
                <Wifi size={20} />
                <Coffee size={20} />
                <Shield size={20} />
            </div>

            <div className="pt-8 border-t border-gray-800/50 w-full max-w-xs mx-auto">
