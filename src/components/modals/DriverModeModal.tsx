...
const DriverModeModal: React.FC<DriverModeModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black z-[60] flex flex-col items-center justify-center p-6 text-center animate-fadeIn">
            ...
            <div className="flex flex-col items-center animate-scaleIn w-full max-w-lg">
                <p className="text-gray-400 text-[10px] mb-8 uppercase tracking-[0.2em] border border-gray-700 px-4 py-1.5 rounded-full font-bold">
                    Mostre ao Motorista
                </p>
                ...
                <div className="bg-gray-900 border border-gray-700 px-6 py-4 rounded-2xl mb-12">
                    <span className="text-gray-400 text-xs uppercase tracking-widest font-bold block mb-1">
                        Complemento
                    </span>
                    <span className="text-orange-500 text-4xl font-bold font-heading tracking-widest">
                        FLAT 304
                    </span>
                </div>
