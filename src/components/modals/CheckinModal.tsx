                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-base font-bold text-gray-800 dark:text-white font-heading">
                                        {isIntegracao
                                            ? 'Pegue as duas chaves no cofre'
                                            : 'Pegue a chave no cofre'}
                                    </p>
                                </div>
                            </div>
                            ...
                            {isPasswordReleased ? (
                                <div className="py-3 text-center bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-600">
                                    <p className="text-[10px] text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-0.5 font-bold">
                                        Senha do Cofre
                                    </p>
                                    <p className="text-2xl font-bold text-gray-900 dark:text-white tracking-widest font-mono notranslate">
                                        {safeCode}
                                    </p>
                                </div>
                            ) : (
                                <div className="py-3 text-center bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-600 flex flex-col items-center justify-center">
                                    ...
                                    <p className="text-lg font-bold text-gray-400 tracking-widest font-mono">
                                        ****
                                    </p>
                                    <p className="text-[10px] text-gray-500 mt-0.5 font-medium bg-gray-200 dark:bg-gray-700 px-2 py-0.5 rounded">
                                        Libera no dia anterior
                                    </p>
                                </div>
                            )}
                                ...
                                {isPasswordReleased ? (
                                    <div className="py-4 text-center bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-600">
                                        <div className="flex items-center justify-center gap-3">
                                            <p className="text-4xl font-bold text-gray-900 dark:text-white tracking-widest font-mono notranslate">
                                                {lockCode || '----'}
                                            </p>
                                        </div>
                                    ...
                                    <div className="py-4 text-center bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-600 flex flex-col items-center justify-center">
                                        ...
                                        <p className="text-[10px] text-gray-500 mt-1 font-medium bg-gray-200 dark:bg-gray-700 px-2 py-0.5 rounded">
                                            Libera no dia anterior
                                        </p>
                                    </div>
                                )}
