    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 animate-fadeIn">
      ...
      <div className="bg-white dark:bg-gray-800 w-full max-w-md rounded-[28px] overflow-hidden shadow-2xl relative z-10 animate-scaleIn flex flex-col max-h-[90vh] border border-white/10">
        ...
        {showKeyDetails ? (
              ...
              <div className="p-5 overflow-y-auto">
                 <div className="mb-5 rounded-2xl overflow-hidden shadow-md border border-gray-200 dark:border-gray-600 relative group">
                    ...
                    <div className="absolute bottom-0 left-0 w-full bg-black/60 p-2 text-center backdrop-blur-sm">
                       <p className="text-white text-xs font-bold uppercase tracking-wider">Caixa Self Checkout</p>
                    </div>
                 </div>
                 ...
                 <div className="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-xl border border-orange-100 dark:border-orange-800/50 mb-4">
                    <div className="flex items-start gap-3">
                       ...
                       <p className="text-sm text-gray-700 dark:text-gray-200 leading-relaxed font-medium">
                         No dia do seu checkout, por favor deposite a chave na caixa do <strong>"Self Checkout"</strong> localizada no primeiro andar ao lado do quadro de avisos.
                       </p>
                    </div>
                 </div>
                 ...
                 <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-xl border border-red-100 dark:border-red-800/50 flex items-start gap-3">
                    ...
                    <div>
                       <p className="text-xs font-bold text-red-700 dark:text-red-300 uppercase mb-1">Importante</p>
                       <p className="text-sm text-red-800 dark:text-red-200 font-bold leading-snug">
                         Deposite a chave SOMENTE DEPOIS de abrir o portão de entrada/saída!
                       </p>
          ...
          /* === CONTEÚDO 2: CHECKLIST PADRÃO === */
          <>
            <div className="p-6 bg-gradient-to-br from-blue-600 to-indigo-600 text-white">
              <h2 className="text-xl font-heading font-bold mb-1">Check-out Sem Estresse 😎</h2>
              <p className="text-blue-100 text-xs font-medium opacity-90">Tudo pronto para partir?</p>
            </div>
            ...
            <div className="p-5 overflow-y-auto space-y-5 bg-gray-50/50 dark:bg-gray-900/50">
              <div className="bg-white dark:bg-gray-700 p-4 rounded-2xl border border-gray-100 dark:border-gray-600 flex items-center justify-between shadow-sm">
                  <div>
                    <p className="font-bold text-gray-900 dark:text-white font-heading text-sm">Horário Limite</p>
                    <p className="text-[10px] text-gray-500 dark:text-gray-400 font-medium mt-0.5">Para a limpeza iniciar.</p>
                  </div>
                  <p className="text-2xl font-bold text-blue-600 dark:text-blue-400 font-heading">{config.checkOutTime || '11:00'}</p>
              </div>

              <div className="space-y-2.5">
                  <p className="text-[10px] font-bold uppercase tracking-wider text-gray-400 dark:text-gray-500 font-heading pl-1">Checklist Rápido</p>
                  ...
                  <div className="flex items-start gap-3 bg-white dark:bg-gray-700 border border-gray-100 dark:border-gray-600 p-3 rounded-xl shadow-sm">
                    <div className="bg-green-100 dark:bg-green-900/30 p-1 rounded-full text-green-600 dark:text-green-400 mt-0.5"><Check size={12} strokeWidth={3} /></div>
                    <div>
                      <p className="font-bold text-gray-800 dark:text-gray-100 text-xs">Caça ao Tesouro</p>
                      <p className="text-[10px] text-gray-500 dark:text-gray-400 mt-0.5 leading-tight">Verifique gavetas e tomadas (carregadores!).</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 bg-white dark:bg-gray-700 border border-gray-100 dark:border-gray-600 p-3 rounded-xl shadow-sm">
                    <div className="bg-green-100 dark:bg-green-900/30 p-1 rounded-full text-green-600 dark:text-green-400 mt-0.5"><Check size={12} strokeWidth={3} /></div>
                    <div>
                      <p className="font-bold text-gray-800 dark:text-gray-100 text-xs">Tudo Desligado?</p>
                      <p className="text-[10px] text-gray-500 dark:text-gray-400 mt-0.5 leading-tight">Ar condicionado e luzes apagadas.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 bg-white dark:bg-gray-700 border border-gray-100 dark:border-gray-600 p-3 rounded-xl shadow-sm relative overflow-hidden">
                    ...
                    <div className="bg-orange-100 dark:bg-orange-900/30 p-1 rounded-full text-orange-600 dark:text-orange-400 mt-0.5"><Key size={12} strokeWidth={3} /></div>
                    <div className="flex-1">
                      <p className="font-bold text-gray-800 dark:text-gray-100 text-xs">A Chave</p>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-2xl text-center border border-blue-100 dark:border-blue-800/30">
                ...
                <p className="text-[10px] text-blue-700 dark:text-blue-300 mt-0.5 font-medium">Boa viagem de volta!</p>
              </div>
            </div>
          </>
        )}
