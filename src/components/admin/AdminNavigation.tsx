...
const AdminNavigation: React.FC<AdminNavigationProps> = ({
    ...
    return (
        <>
            ...
            {/* MOBILE BOTTOM BAR */}
            <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 pb-safe z-50 px-4 py-2 flex justify-around items-center shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
