        ...
        <div className="space-y-6 animate-fadeIn">
            ...
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-2xl text-sm font-bold shadow-lg shadow-orange-500/20 transition-all flex items-center gap-2"
                >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                <div className="bg-white/60 dark:bg-gray-800/40 backdrop-blur-xl p-5 rounded-[2rem] border border-white/40 dark:border-gray-700/50 shadow-sm hover:shadow-md transition-all group overflow-hidden relative">
                    ...
                    <div className="flex flex-col relative z-10 h-full justify-between">
                        <span className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2 font-heading">
                            Chegando
                        </span>
                        <div className="flex items-center gap-3">
                            <span className="text-3xl font-heading font-bold text-gray-900 dark:text-white">
                                {stats.checkins.length}
                            </span>
                            {stats.checkins.length > 0 && (
                                <span className="text-[10px] font-bold text-blue-600 bg-blue-100 dark:bg-blue-900/30 px-2 py-0.5 rounded-full self-center">
                                    HOJE
                                </span>
                            )}
                        </div>
                    ...
                    <div className="flex flex-col relative z-10 h-full justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            {stats.checkouts.length > 0 && (
                                <span className="text-[10px] font-bold text-red-600 bg-red-100 dark:bg-red-900/30 px-2 py-0.5 rounded-full self-center">
                                    HOJE
                                </span>
                            )}
                        </div>
                ...
                <div className="bg-gradient-to-br from-green-500/5 to-emerald-500/10 dark:from-green-500/10 dark:to-transparent backdrop-blur-xl p-5 rounded-[2rem] border border-green-100/50 dark:border-green-500/20 shadow-sm hover:shadow-md transition-all group overflow-hidden relative">
                    ...
                    <div className="flex flex-col relative z-10 h-full justify-between">
                        <span className="text-xs font-bold text-green-700 dark:text-green-400 uppercase tracking-wider mb-2 font-heading">
                            Hóspedes Ativos
                        </span>
                        <span className="text-3xl font-heading font-bold text-green-800 dark:text-green-100">
                            {stats.active.length}
                        </span>
                    </div>
                </div>
                ...
                <div
                    ...
                    tabIndex={0}
                    onKeyDown={(e) => {
                        if (e.key === 'Enter' || e.key === ' ') onNavigate('list');
                    }}
                >
                    ...
                    <div className="flex flex-col relative z-10 h-full justify-between">
                        <span className="text-xs font-bold text-orange-100 uppercase tracking-wider mb-2 font-heading">
                            Total Reservas
                        </span>
                        <div className="flex items-center justify-between">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {stats.active.map((res) => (
                            ...
                            >
                                ...
                                <div>
                                    <p className="font-bold text-gray-900 dark:text-white group-hover:text-green-700 dark:group-hover:text-green-400 transition-colors font-heading">
                                        {res.guestName}
                                    </p>
                            ...
                            {stats.checkins.map((res) => (
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="font-bold text-sm text-gray-900 dark:text-white font-heading">
                                                {res.guestName}
                                            </p>
