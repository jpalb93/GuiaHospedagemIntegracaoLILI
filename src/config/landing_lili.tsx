...
export const LANDING_LILI_CONTENT = {
    ...
    amenities: [
            ...
            icon: (
                <div className="text-amber-700">
                    <img
                        ...
                        alt="shower"
                        style={{ filter: 'sepia(100%) hue-rotate(350deg) saturate(500%)' }}
                    />
                </div>
            ),
            items: [
        ...
        },
        {
            ...
            title: 'Climatização',
            icon: <Wind className="text-amber-700" />,
            items: ['Ar-condicionado split', 'Ventiladores portáteis'],
        },
        {
            id: 'cozinha',
        ...
        },
        {
            ...
            items: ['Wi-Fi de alta velocidade', 'Espaço de trabalho exclusivo (Escrivaninha)'],
        },
        {
            id: 'seguranca',
    ...
    location: {
        ...
        description:
            'Encontre-nos no coração de Petrolina, com fácil acesso aos melhores pontos da cidade.',
    },
    reviews: {
