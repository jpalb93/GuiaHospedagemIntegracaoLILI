...
export interface PropertyConfig {
    ...
    address: string;
    units?: string[]; // Lista de flats/unidades para seleção (ex: ['201', '202', ...])
    hostPhone: string;
...
`,
    ...
    integracao: {
        ...
        address: 'R. São José, 475 - Centro, Petrolina - PE, 56302-270',
        units: ['201', '202', '301', '302', '303', '304', '401', '402', '403', '404'],
        hostPhone: '5587988283273', // Flats Integração (Geral)
        googleReviewLink:
